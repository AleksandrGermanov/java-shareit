...
public class BookingControllerTest {
    ...
    @Test
    @SneakyThrows
    public void methodFindByBookerAndByStateValueUnsupportedCallsServiceAndReturnsEmptyList() {
        mockMvc.perform(get("/bookings?state=unsupported&from=0&size=2")
                        .accept(MediaType.APPLICATION_JSON)
                        .header("X-Sharer-User-Id", "999"))
    ...
    @Test
    @SneakyThrows
    public void methodFindByItemOwnerAndByStateValueUnsupportedCallsServiceAndReturnsEmptyList() {
        mockMvc.perform(get("/bookings/owner?state=unsupported&from=0&size=2")
                        .accept(MediaType.APPLICATION_JSON)
                        .header("X-Sharer-User-Id", "999"))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$").isMap())
